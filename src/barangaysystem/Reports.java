...
Object[] cols = null;
    ...
    private void initComponents() {
        ...
        rcmdAuditTrail.setBounds(123, 63, 100, 40);
        ...
        rcmdReports.setBounds(30, 63, 81, 40);

        pnlAuditTrail.setBackground(new java.awt.Color(255, 255, 255));
        pnlAuditTrail.setLayout(null);

        cmdCancel1.setBackground(new java.awt.Color(102, 102, 102));
        ...
        cmdConfirm1.setBackground(new java.awt.Color(102, 102, 102));
        ...
        lblBackround.setIcon(new javax.swing.ImageIcon(getClass().getResource("/barangaysystem/image/ReportsUI.jpg"))); // NOI18N
