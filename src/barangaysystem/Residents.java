 ...
 * @author Admin
 */
public final class Residents extends javax.swing.JFrame {
...
Object[] cols = null;
    ...
    try{
            ...
            pst.setString(5, lblSelectedResidentsID.getText());
    ...
    private void initComponents() {
        ...
        lblTotalResult.setBounds(20, 80, 52, 40);
        ...
        cmdRequestDocument.setBackground(new java.awt.Color(51, 204, 255));
        ...
        lblSelectedRowResidentID.setBounds(470, 20, 120, 15);
        ...
        pnlResidentssList.setBounds(190, 110, 490, 490);
        ...
        pnlPersonalInfo.setBounds(10, 230, 280, 170);
        ...
        jPanel2.setBounds(10, 400, 280, 80);
        ...
        pnlQuickView.setBounds(690, 110, 300, 490);
        ...
        txtSearch.setBounds(280, 70, 370, 30);
        ...
        lblBackround.setIcon(new javax.swing.ImageIcon(getClass().getResource("/barangaysystem/image/ResidentsListUILarge.jpg"))); // NOI18N
    ...
    private void txtSearchKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtSearchKeyReleased
        ...
        if(txtSearch.getText().equals("")){
            ...
            UsersTable();
                ...
                try{
                    String getName = txtSearch.getText();
            ...
            String sql2 = "SELECT `ResidentID`,`fname`,`mname`,`lname` FROM `residents` WHERE  ResidentID LIKE '%"+getName+"%' and `archive`='No' or fname LIKE '%"+getName+"%' and `archive`='No' or mname LIKE '%"+getName+"%' and `archive`='No' or lname LIKE '%"+getName+"%' and `archive`='No'";
    ...
    private void txtSearchMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_txtSearchMouseClicked
        // TODO add your handling code here:
        if(txtSearch.getText().equals("Search Residents Here...")){
